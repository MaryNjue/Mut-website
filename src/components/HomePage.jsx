        ...
        <section className="testimonials">
            ...
            <div className="testimonial-cards">
                <div className="testimonial-card">
                    <img src="/src/assets/user1.jpg" alt="Member 1" className="testimonial-image" />
                ...
                <div className="testimonial-card">
                    <img src="/src/assets/user7.jpg" alt="Member 2" className="testimonial-image" />
                ...
                <div className="testimonial-card">
                    <img src="/src/assets/user2.jpg" alt="Member 3" className="testimonial-image" />
                ...
                <div className="testimonial-card">
                    <img src="/src/assets/user8.jpg" alt="Member 4" className="testimonial-image" />
                ...
                <div className="testimonial-card">
                    <img src="/src/assets/user5.jpg" alt="Member 5" className="testimonial-image" />
                ...
                <div className="testimonial-card">
                    <img src="/src/assets/user9.jpg" alt="Member 6" className="testimonial-image" />
